...
const jdecnctool = new function () {
    ...
    this.HTMLServerConnector = new function () {
        this.loginToJDE = async function (page, jdeUrl, doorlock, doorkey) {
        ...
        this.logoutFromJDE = async function (page) {
            await page.click('#userSessionDropdownArrow');
            await page.waitForSelector('#logoutIcon');
            await page.click('#logoutIcon');
        }

        this.launchJDEAppOnFastPath = async function (page, appName, htmlSelector) {
            await page.waitForSelector('#drop_mainmenu');
    ...
    this.AISServerConnector = new function () {
